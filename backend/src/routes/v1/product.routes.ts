...
productRouter.post('/', requireRoleMiddleware(UserRole.Admin), createProductValidator, singleImageUpload('image'), wrapRequestHandler(productController.createProduct))
