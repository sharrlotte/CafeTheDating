...
export default function HomePage() {
	...
	return (
		<div className='h-full md:p-20 p-4 md:text-white md:drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] flex flex-col gap-4 justify-end items-start text-black'>
			...
			<p className='max-w-md'>Điểm đến lý tưởng cho các buổi hẹn lãng mạn. Với không gian ấm áp, menu đa dạng và không khí riêng tư, quán hứa hẹn tạo ra những trải nghiệm đặc biệt và nhớ mãi cho các cặp đôi.</p>
			<Button
				className='bg-[#007B0C] flex items-center justify-center'
				asChild
			>
