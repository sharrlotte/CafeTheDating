  ...
  return (
    <>
      ...
      <div className="flex gap-2 flex-col">
        <div className=" ">
          <span className="text-5xl  flex justify-center p-2">
        ...
        <div className="bg-[hsla(0,0%,85%,1)] flex justify-center items-center p-2 rounded-xl">
          <div>
            <div className="flex justify-center items-center">
              <span className=" bg-[hsla(32,98%,51%,1)] rounded-2xl flex items-center justify-center w-full max-w-[70%] md:max-w-[50%] h-10 font-bold">
        ...
        <div className="flex gap-2 flex-col rounded-md">
          <div className="relative grid md:grid-cols-[1fr_auto] gap-2 grid-cols-1">
            <div className="relative h-full flex">
              <img
                ...
                alt="Loading"
              ></img>
              <span className="text-white text-3xl font-bold bottom-24 left-10 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] absolute md:whitespace-nowrap">
          ...
          <div className="relative flex">
            ...
            <div className=" flex absolute md:bottom-12 md:left-32 bottom-2 gap-2 left-2 flex-col">
              <span className="text-white text-3xl font-bold md:bottom-24 md:left-32 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
                Phục vụ tận tâm
              </span>
              <Button className="border-none rounded-3xl bg-[hsla(26,87%,51%,1)] text-white hover:bg-[#ea5f6b] drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
                Nhận xét ngay
              </Button>
            </div>
          </div>
